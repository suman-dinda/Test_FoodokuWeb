...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/customerlist" class="uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>

<a class="export_btn uk-button mbtn" rel="rptCustomerList" href="javascript:;"><?php echo t("Export to Mailchimp mailing list")?></a>
