...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal" class="w-list incoming uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","Incoming withdrawal")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal/?do=approved" class="w-list approved uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","Approved withdrawal")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal/?do=paid" class="w-list paid uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","Paid withdrawal")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal/?do=denied" class="w-list denied uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","Denied withdrawal")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal/?do=failed" class="w-list failed uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","Failed withdrawal")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal/?do=cancel" class="w-list cancel uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","Cancel withdrawal")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal/?do=reversal" class="w-list reversal uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","Reversal withdrawal")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/incomingwithdrawal/?do=all" class="w-list all uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","All withdrawal")?></a>
...
<div class="uk-form-row">
  ...
  <a  href="javascript:;" rel="rpt_incomingwithdrawal" class="export_btn uk-button mbtn"><?php echo t("Export")?></a>
</div>  
