...
<a class="uk-button mbtn" style="padding-top: 1%;padding-bottom: 1%" target="_blank" href="<?php echo websiteUrl()?>/update">
...
<h3 class="heading-shade"><?php echo Yii::t("default","New Merchant Registration List For Today")?> <span class="uk-text-success">
<?php
 //echo date('F d, Y')
...
<h3 class="heading-shade"><?php echo Yii::t("default","New Merchant Payment List For Today")?> <span class="uk-text-success">
...
<h3 class="heading-shade"><?php echo Yii::t("default","Incoming orders from merchant for today")?> <span class="uk-text-success">
<?php echo FormatDateTime(date('c'),false); //echo date('F d, Y')?></span></h3>
