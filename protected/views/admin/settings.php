...
<div class="uk-form-row"> 
 <label class="uk-form-label"><?php echo Yii::t('default',"Desktop Website Logo")?></label>
  <div style="display:inline-table;margin-left:1px;" class="button uk-button mbtnBrowse" id="photo"><?php echo Yii::t('default',"Browse")?></div>	  
...
<div class="uk-form-row"> 
 <label class="uk-form-label"><?php echo Yii::t('default',"Mobile Website Logo")?></label>
  <div style="display:inline-table;margin-left:1px;" class="button uk-button mbtnBrowse" id="mobilelogo"><?php echo Yii::t('default',"Browse")?></div>	  
...
<div class="uk-form-row"> 
 <label class="uk-form-label"><?php echo Yii::t('default',"Receipt Logo")?></label>
  <div style="display:inline-table;margin-left:1px;" class="button uk-button mbtnBrowse" id="rphoto"><?php echo Yii::t('default',"Browse")?></div>	  
...
<div class="uk-form-row"> 
 <label class="uk-form-label"><?php echo Yii::t('default',"Map Icon Marker")?></label>
  <div style="display:inline-table;margin-left:1px;" class="button uk-button mbtnBrowse" id="photo2"><?php echo Yii::t('default',"Browse")?></div>	  
