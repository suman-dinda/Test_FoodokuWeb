...
<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/merchantAdd" class="uk-button mbtn"><i class="fa fa-plus"></i> <?php echo Yii::t("default","Add New")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/merchantAddBulk" class="uk-button mbtn"><i class="fa fa-plus"></i> <?php echo Yii::t("default","Upload Bulk CSV")?></a>

<a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/merchant" class="uk-button mbtn"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
</div>
