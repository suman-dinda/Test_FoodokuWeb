...
<div class="header_wrap">
  ...
  <a target="_blank" class="uk-button mbtn" href="<?php echo Yii::app()->createUrl('/')?>/"><i class="fa fa-cutlery"></i> <?php echo t("View Website")?></a>
  </div>
  
	<div data-uk-dropdown="{mode:'click'}" class="uk-button-dropdown">
	<button class="uk-button mbtn"><i class="fa fa-user"></i> <?php echo $admin_info['username'] ?> <i class="uk-icon-caret-down"></i></button>
